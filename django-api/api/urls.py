...
user_controller = ApiController(User, model_name='user')
track_controller = ApiController(Track, model_name='track', parent_model=User, parent_name='user')
collaborator_controller = ApiController(Collaborator, model_name='collaborator', parent_model=Track, parent_name='track')
file_controller = ApiController(File, model_name='file', parent_model=Track, parent_name='track')
agreement_controller = ApiController(Agreement, model_name='agreement', parent_model=Track, parent_name='track')
comment_controller = ApiController(Comment, model_name='comment', parent_model=Track, parent_name='track')
